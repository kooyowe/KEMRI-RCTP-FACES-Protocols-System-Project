...
/*	+---------------------------------------------------------------------------------------+
	...
	|Language: PHP
	|Author: Kevin Oyowe
	|->This script does not send an email to the specified email address that belongs to
	|	the PI(Principal Investigator) whose Protocol has expired at the time of
	|	running the script. It tests!!
...
while($protocolRow = $protocolStmt->FetchObject()){
	...
	if(isset($transactionRow->transaction_id)){
		...
		if(($sign=='+')&&(($days==60)||($days==44)||($days==30))){
			...
			<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
				...
				<body>
				  <div style="width: 640px; font-family: Arial, Helvetica, sans-serif; font-size: 11px;">
					...
					<span style="color:blue">You are getting this message as free service for being a user of the KEMRI-RCTP FACES Protocols Management System(ProMS) Pilot Vs 1.0.</span>
				  </div>
				</body>
				</html>
			';
			...
			';
				// test runs here
				echo '1. [the html message]<br>';
				echo $htmlMessage.'<br>';
				
				echo '2. [alternative message]<br>';
				echo $alternativeMessage.'<br>';
